...
object LagomscalachirperService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The lagom-scala-chirper service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the LagomscalachirperService.
  */
trait LagomscalachirperService extends Service {
  ...
  override final def descriptor = {
    import Service._
    // @formatter:off
    named("lagom-scala-chirper")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(LagomscalachirperService.TOPIC_NAME, greetingsTopic _)
